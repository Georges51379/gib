...
const ProjectsPage = () => {
  ...
  const title = "Projects Portfolio | Georges Boutros - Case Studies";
  ...
  return (
    <div className="min-h-screen">
      <SEO 
        ...
        type="website"
        schema={schema}
        keywords="projects, portfolio, web applications, case studies, React, Node.js, Python, full stack, data engineering, Georges Boutros, Lebanon, Lebanese developer"
